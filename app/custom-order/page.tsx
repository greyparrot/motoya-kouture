        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="font-serif text-4xl md:text-5xl font-semibold mb-4">Custom Order Request</h1>
              <p className="text-lg text-muted-foreground">
                Let's create something extraordinary together. Share your vision with us.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {/* Event Details */}
              <div className="bg-card p-6 rounded-lg border border-border">
                <h2 className="font-serif text-2xl font-semibold mb-6">Event Details</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        ...
                        >
                          <CalendarIcon className="mr-2 h-4 w-4" />
                          {dateNeeded ? format(dateNeeded, "PPP") : "Pick a date"}
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent className="w-auto p-0">
                        <Calendar mode="single" selected={dateNeeded} onSelect={setDateNeeded} initialFocus />
                      </PopoverContent>
                    </Popover>
                    <p className="text-sm text-muted-foreground">Minimum 6 weeks from today recommended</p>
                  </div>
                </div>
              </div>
              ...
              {/* Design Preferences */}
              <div className="bg-card p-6 rounded-lg border border-border">
                <h2 className="font-serif text-2xl font-semibold mb-6">Design Preferences</h2>
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="fabricPreference" placeholder="e.g., Satin, Lace, Chiffon" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="colorPreference">Color Preference</Label>
                    <Input id="colorPreference" placeholder="e.g., Ivory, Blush, Navy" />
                  </div>
                  <div className="space-y-2">
              ...
              <div className="bg-card p-6 rounded-lg border border-border">
                <h2 className="font-serif text-2xl font-semibold mb-6">Inspiration & References</h2>
                <div className="space-y-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="pinterest" type="url" placeholder="https://pinterest.com/..." />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="instagram">Instagram Reference</Label>
                    <Input id="instagram" placeholder="@username or post link" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card p-6 rounded-lg border border-border">
                <h2 className="font-serif text-2xl font-semibold mb-6">Budget & Additional Information</h2>
                <div className="space-y-4">
                  <div className="space-y-2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button type="submit" size="lg" className="flex-1" disabled={isSubmitting}>
                  {isSubmitting ? "Submitting..." : "Submit & Chat with Designer"}
                </Button>
              ...
              <p className="text-sm text-center text-muted-foreground">
                By submitting this form, you agree to be contacted by our design team via email, phone, or WhatsApp.
              </p>
            </form>
          </div>
        </div>
